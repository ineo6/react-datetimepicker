...
export default class DateTimeField extends Component {
    ...
    state = {
        ...
        buttonIcon: this.props.mode === Constants.MODE_TIME ? "clock-o" : "calendar",
        widgetStyle: {
            display: "block",
            position: "absolute",
            left: -9999,
    ...
    onClick = () => {
        ...
        if (this.state.showPicker) {
            ...
            classes.aLeft = this.props.pickerAlign == "left" ? true : false;
            classes.aRight = this.props.pickerAlign == "right" ? true : false;
            return this.setState({
                widgetStyle: styles,
