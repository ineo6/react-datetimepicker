    ...
    if (!this.state.minutesDisplayed && !this.state.hoursDisplayed) {
      ...
      <div className="timepicker-picker">
        <table className="table-condensed">
          <tbody>
            <tr>
              <td><a className="btn" onClick={this.props.addHour}><Icon name="chevron-up" /></a></td>

              <td className="separator"></td>

              <td><a className="btn" onClick={this.props.addMinute}><Icon name="chevron-up" /></a></td>
            ...
            <tr>
              <td><a className="btn" onClick={this.props.subtractHour}><Icon name="chevron-down" /></a></td>

              <td className="separator"></td>

              <td><a className="btn" onClick={this.props.subtractMinute}><Icon name="chevron-down" /></a></td>
